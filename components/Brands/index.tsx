    ...
    <>
      <section>
        <div className="relative  flex flex-wrap justify-center p-4">
          <div className="relative z-99999   w-full max-w-7xl rounded-2xl bg-primary p-15">
            ...
            <div className="grid items-center gap-4 md:grid-cols-3">
              <div className="text-center text-3xl font-semibold text-black md:text-left">
              ...
              <div className="text-center text-sm text-gray-600 md:text-right">
                <div className="flex flex-row items-center justify-center gap-4">
                  ...
                  <div>
                    <p className="font-sm text-xl text-black">For Any Call</p>
                    <h1 className="text-3xl text-black font-semibold">+94 77 714 7238</h1>
                  </div>
                </div>
              </div>
            </div>
